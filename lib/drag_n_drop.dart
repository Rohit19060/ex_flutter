  ...
  Widget _buildPersonWithDropZone(Customer customer) => Expanded(
        child: Padding(
          ...
          child: DragTarget<Item>(
            builder: (context, candidateItems, rejectedItems) => CustomerCart(
...
class CustomerCart extends StatelessWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<bool>('hasItems', hasItems));
...
class MenuListItem extends StatelessWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<bool>('isDepressed', isDepressed));
